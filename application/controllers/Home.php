...
class Home extends CI_Controller {
	...
	public function index(){
		...
		$data['list_masuk'] = $this->db->query("SELECT count(kd_masuk) FROM tbl_masuk RIGHT JOIN tbl_kendaraan ON tbl_masuk.kd_kendaraan = tbl_kendaraan.kd_kendaraan WHERE status_masuk LIKE '1'")->row_array();
