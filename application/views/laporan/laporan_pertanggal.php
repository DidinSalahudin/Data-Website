...
<tbody>
    <?php foreach ($laporan as $row) { $jenisKendaraan = $this->db->query("SELECT * FROM tbl_kendaraan WHERE kd_kendaraan = '".$row['kd_kendaraan']."' ")->row_array(); ?>
    <tr>
        <td style="text-align:center;"><?php echo $row['kd_masuk'];?></td>
        <td style="text-align:center;"><?php echo $jenisKendaraan['nama_kendaraan'];?></td>
