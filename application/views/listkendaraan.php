                  ...
                  <div class="card-body">
                    ...
                    <?php foreach ($masuk as $row) { ?>
                        <tr>
                          ...
                          <td><a href="<?php echo base_url('masuk/printmasuk/'.$row['kd_masuk']) ?>"><i class="fa fa-barcode"></i></a> | <a href="<?php echo base_url('masuk/delete/'.$row['kd_masuk']) ?>"><i class="fa fa-trash"></i></a></td>
                        </tr>
                      <?php } ?>
                      </tbody>
                      </table>
