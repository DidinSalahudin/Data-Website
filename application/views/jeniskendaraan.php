            ...
            <div class="card-body">
              ...
              <?php foreach ($jenis as $row) { ?>
                <tr>
                  ...
                  <td align="center"><a href="<?php echo base_url('jeniskendaraan/editkendaraan/edit/'.$row['kd_kendaraan']) ?>" title="Edit"><i class="fa fa-edit"></i></a> | <a href="<?php echo base_url('jeniskendaraan/deletekendaraan/'.$row['kd_kendaraan']) ?>" title="Hapus"><i class="fa fa-trash"></i></a></td>
                </tr>
              <?php } ?>
                </tfoot>
              </table>
