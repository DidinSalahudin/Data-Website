                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url('laporan/laportanggal') ?>" target="_blank">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <select name="jenis_kendaraan" class="form-control" data-live-search="true" style="width:300px;" title="Pilih Jenis Kendaraan" data-width="80%" required/>
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url('laporan/laporbulan') ?>" target="_blank">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label col-xs-3" > Jenis Kendaraan</label>
                            <div class="col-xs-9">
                                <select name="jenis_kendaraan" class="form-control" data-live-search="true" title="Pilih Jenis Kendaraan" data-width="80%" required/>
                                    <option value='all' selected>Semua</option>
                                <?php foreach ($jenis_kendaraan as $row) { ?>
                                    <option value="<?php echo $row['kd_kendaraan'] ?>"><?php echo $row['nama_kendaraan'] ?></option>
                                <?php } ?>
